# {{APP_NAME}} Android APK build script (Windows)
...
if (-not (Test-Path "src-tauri\gen\android\app\build.gradle.kts")) {
    Write-Host "Android project not patched yet — running android:patch"
    & "$PSScriptRoot\patch-android.ps1"
}
